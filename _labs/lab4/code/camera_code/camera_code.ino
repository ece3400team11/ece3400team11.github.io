...
void write_reg() {
  int i = 0;
  while(ov7670_default_regs[i].reg_num != 0xff && ov7670_default_regs[i].value != 0xff) {
      String result = OV7670_write_register(ov7670_default_regs[i].reg_num, ov7670_default_regs[i].value);
  Serial.println(result);
